...
const Nav = () => {
  ...
  return (
    <div className="nav md:h-screen flex md:flex-col md:top-0 md:relative absolute z-[100] bottom-[5%] w-full md:w-[30%] items-center justify-around   p- rounded-full">
      <Link
        to="/"
      ...
      >
        <span className="">
          <BiHomeAlt className={`w-6 h-6 rounded-full`} />
        </span>
      </Link>
      <Link
        className={`p-2 border ${
      ...
      <Link
        className={`p-2 border ${
          active == "last" ? "bg-green-400" : "border-green-600"
        } rounded-full`}
        to="last"
      >
        <span>
